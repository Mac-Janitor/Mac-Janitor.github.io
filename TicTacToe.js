...
// include: C:\Users\Admin\AppData\Local\Temp\tmpra0twa3d.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'TicTacToe.data';
      var REMOTE_PACKAGE_BASE = 'TicTacToe.data';
...
Module['FS_createPath']("/resources/shaders", "glsl330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_TicTacToe.data');

      };
      Module['addRunDependency']('datafile_TicTacToe.data');
    ...
    loadPackage({"files": [{"filename": "/resources/.DS_Store", "start": 0, "end": 8196}, {"filename": "/resources/fonts/AnonymousPro-Bold.ttf", "start": 8196, "end": 161812}, {"filename": "/resources/fonts/NorthernLights.ttf", "start": 161812, "end": 200948}, {"filename": "/resources/shaders/glsl330/blur_darken.fs", "start": 200948, "end": 202072}, {"filename": "/resources/shaders/glsl330/outlineSDF.fs", "start": 202072, "end": 202977}, {"filename": "/resources/sprBoard.png", "start": 202977, "end": 254021}, {"filename": "/resources/sprO.png", "start": 254021, "end": 309937}, {"filename": "/resources/sprX.png", "start": 309937, "end": 357620}], "remote_package_size": 357620});

  })();

// end include: C:\Users\Admin\AppData\Local\Temp\tmpra0twa3d.js
// include: C:\Users\Admin\AppData\Local\Temp\tmp2jlidkb5.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\Admin\AppData\Local\Temp\tmp2jlidkb5.js
// include: C:\Users\Admin\AppData\Local\Temp\tmpwhaxbph1.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\Admin\AppData\Local\Temp\tmpwhaxbph1.js
